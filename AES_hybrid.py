#!/usr/bin/env python3
"""
This algorihtm is Hybrid version of original AES algorihtm.So this is my novel idea of making a hybrid to aes.Basically design
...
We have even checked the time taken to execute and it is lower than the normal aes.
"""
